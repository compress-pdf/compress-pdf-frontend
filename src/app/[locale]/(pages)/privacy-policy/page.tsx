      ...
      >
        ...
        <SectionContainer className="text-center flex flex-col md:flex-row gap-9 ">
          <section className="flex flex-col gap-[17px] justify-start items-start">
            <h1 className="text-[#163B45] dark:text-[#FAFAFA] 2xl:text-[40px] 2xl:leading-[48px] font-bold xl:text-xl xl:leading-7 lg:text-[40px] lg:leading-[48px] md:text-xl md:leading-7 text-[18px] leading-5 mb-[17px]">
              {t('heading')}
            </h1>
            <p className="text-justify text-[#163B45] dark:text-[#E1DEDE] 2xl:text-base 2xl:leading-7 xl:text-sm xl:leading-5 lg:text-base lg:leading-7 md:text-sm md:leading-5 text-[10px] leading-4 mb-[17px]">
              {t('description')}
            </p>
              ...
              <li className="mt-[17px]">
                <p className="2xl:text-base 2xl:leading-7 xl:text-sm lg:text-base md:text-sm text-[10px] leading-4 font-normal flex items-center gap-1">
                  ...
                  <span className="text-[#B23F40] dark:text-[#FF8224] ">
                    {t('sectionSeven.email')}:
                  </span>
                  {t('sectionSeven.emailInfo')}
                </p>
              </li>
              <li className="my-2">
                <p className="2xl:text-base 2xl:leading-7 xl:text-sm lg:text-base md:text-sm text-[10px] leading-4 font-normal flex items-center gap-1">
                  ...
                  <span className="text-[#B23F40] dark:text-[#FF8224] ">
                    {t('sectionSeven.address')}:
                  </span>
                  {t('sectionSeven.addressInfo')}
                </p>
              </li>
              <li>
                <p className="2xl:text-base 2xl:leading-7 xl:text-sm lg:text-base md:text-sm text-[10px] leading-4 font-normal flex items-center gap-1">
                  ...
                  <span className="text-[#B23F40] dark:text-[#FF8224] ">
                    {t('sectionSeven.phone')}:
                  </span>
                  {t('sectionSeven.phoneInfo')}
                </p>
              </li>
              <li className="mt-[17px]">
                <p className="text-left text-[#6B7280] dark:text-[#FAFAFA] 2xl:text-base 2xl:leading-7 xl:text-sm lg:text-base md:text-sm text-[10px] leading-4 font-normal">
                  {t('sectionSeven.thankyou')}
                </p>
              </li>
            </ol>
          </section>
