    ...
    >
      ...
      {isOpen && (
        <div
          ...
          className={`bg-[#163b45] dark:bg-[#F2F2F2] text-[#fafafa] dark:text-[#000000] w-max text-wrap max-w-[180px] font-normal leading-tight text-left text-sm px-[10px] py-2 rounded shadow-lg z-50 border border-slate-500 ${
            hide && 'hidden'
          }`}
        >
          <p>{content}</p>
