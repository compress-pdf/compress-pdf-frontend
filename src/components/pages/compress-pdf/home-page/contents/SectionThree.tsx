      ...
      <div className="mt-10 flex flex-col lg:gap-10 gap-5 ">
        <div className="flex flex-col md:flex-row lg:gap-[14px] gap-1 bg-[#F3F3F3] dark:bg-[#2F2F2F] rounded-[10px]">
          <div className="flex flex-col items-start gap-y-5 lg:pl-10 px-5 lg:py-[37px] py-5">
            <h3 className="text-base rounded-3xl bg-[linear-gradient(to_bottom_right,_#8b0000,_transparent_50%,_transparent_70%,_#8b0000)] px-[1px]">
              <span className="px-5 bg-[#F3F3F3] rounded-[22px] leading-none text-[#B23F40]">
                {t('content.sectionThree.stepOne.stepNumber')}
              </span>
            </h3>
            <h3 className="3xl:text-xl font-semibold 3xl:leading-7 2xl:text-[22px] 2xl:leading-[26.4px] xl:text-lg xl:leading-6 lg:text-[22px] lg:leading-[26.4px] md:text-lg md:leading-6 text-base leading-5 text-left 3xl:w-[80%] w-full ">
        ...
        <div className="flex 3xl:flex-row flex-col gap-2">
          ...
          <div className="flex flex-col items-start px-10 py-[37px] bg-[#F3F3F3] dark:bg-[#2F2F2F] rounded-[10px]">
            ...
            <h3 className="3xl:text-xl 3xl:leading-[1.8rem] 3xl:w-[80%] w-full  2xl:text-[22px] 2xl:leading-[26.4px] xl:text-lg xl:leading-6 lg:text-[22px] lg:leading-[26.4px] md:text-lg md:leading-6 text-base leading-5 text-left mt-4 font-semibold">
          ...
          <div className="flex flex-col items-start px-10 py-[37px] bg-[#F3F3F3] dark:bg-[#2F2F2F] rounded-[10px]">
            ...
            <h3 className="3xl:text-xl 3xl:leading-[1.8rem] 3xl:w-[90%] w-full 2xl:text-[22px] 2xl:leading-[26.4px] xl:text-lg xl:leading-6 lg:text-[22px] lg:leading-[26.4px] md:text-lg md:leading-6 text-base leading-5 text-left mt-4 font-semibold">
